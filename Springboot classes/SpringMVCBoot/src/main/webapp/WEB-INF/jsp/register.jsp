	...
	<section id="registration" class="section">
	 ...
	 <em>Register User</em><br/>
    		 ...
    		 <form:form method="post" action="/registerUser" modelAttribute="newuser">
    		    ...
    		    <form:radiobutton path="activity" id="activity" value="Sport"/>
    		    <label>Play a sport ?</label>
    		    <form:radiobutton path="activity" id="activity" value="Gym"/>
	...
	<footer class="footer">
		<div class="container">
			...
			<p class="legal">H+ Sport is a fictitious brand created by
				javaspring hibernate.com solely for the purpose of training. All products and
